...
Sessions are uploaded programmatically via the API.
...
- claude_session_id: Claude session ID (for resume command)
- project_path: Project directory path
- pr_url: Associated pull request URL
- session_data: JSON/JSONL of messages (or upload session_file)
- diff_data: Diff/patch content (or upload diff_file)
```
...
Accepts Claude Code's native JSONL format or JSON array:
```json
[
